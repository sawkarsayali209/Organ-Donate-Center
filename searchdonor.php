        ...
        if ($result) {
            ...
            <tr>
                ...
                <td>{$row['hospital_name']}</td>
                     <td>
                    <a class='delete-link' href='deletedonor.php?id={$row['donor_id']}'>Delete</a>
                </td>
                ...
                echo "<div class='form'>
                      <h3>No donors found for organ: $organ.</h3><br/>
                      <p class='link'>Click here to <a href='searchdonor.php'>Search Again</a>.</p>
                      </div>";
            }
        } else {
...
<div class="container">
    <form class="form" method="post" name="search" action="">
        <h1 class="title">Search Donor by Organ</h1>
